    ...
    class Transaction
    {
        public static List<float> totalsCalc(List<Product> Cart)
        {
            ...
            foreach (var item in Cart)
            {
                ...
                {
                    Console.WriteLine(String.Format("{0,-20} {1,0} {2,0}", item.Name, item.Description.PadRight(30), item.Price.ToString("C").PadLeft(16)));
                }
            ...
            Console.WriteLine("--------------------------------------------------------------------");
            Console.BackgroundColor = ConsoleColor.DarkMagenta;
            Console.WriteLine(String.Format("{0,-10} {1,57}","SUBTOTAL",subTotal.ToString("C")));
            Console.WriteLine(String.Format("{0,-10} {1,57}","SALESTAX",taxTotal.ToString("C")));
            Console.WriteLine(String.Format("{0,-10} {1,57}","GRANDTOTAL",grandTotal.ToString("C")));
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine();
            return (allTotals);
        }
